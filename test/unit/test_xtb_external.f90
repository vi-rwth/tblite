...
subroutine test_d_mb03(error)
   ...
   call xtb_singlepoint(ctx, mol, calc, wfn0, acc, energy, verbosity=0, 0)
   ...
   do i = 1, 3
      ...
      cont = electric_field(efield)
      call calc%push_back(cont)
      call xtb_singlepoint(ctx, mol, calc, wfn, acc, er, verbosity=0, 0)
      ...
      cont = electric_field(efield)
      call calc%push_back(cont)
      call xtb_singlepoint(ctx, mol, calc, wfn, acc, el, verbosity=0, 0)
